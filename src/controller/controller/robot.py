...
class Robot:
    ...
    def __init__(self, name, viz_data_dict):
        ...
        STORE.set('general','mapper_node_callback_interval',1.0)
        STORE.set('general','world_inter_regional_cache_updation_period',60.0)
        STORE.set('general','planning_cost_map',{'hypercritical':100,'angular':10,'metric':1})
        STORE.set('general','planner_node_callback_interval',0.5)
        STORE.set('general','visualizer_node_callback_interval',2.0)
        ...
        STORE.set('general','visualized_map_size',(500,500))
